...
OPENAI_TRANSLATE_MAX_TOKENS = int(os.getenv("OPENAI_TRANSLATE_MAX_TOKENS", "2000"))
...
class RecipeTranslator:
    ...
    def _system_prompt(self) -> str:
        return (
            ...
            f"{self.target_language}. Translate ALL human-readable text values, including the "
            "recipe name, ingredients list, instructions, and tags. Return ONLY valid JSON with "
            "the same keys and structure as the input. Preserve numbers, measurements, and units. "
