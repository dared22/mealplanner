...
- [x] **UI-01**: User can swap individual meals in generated plan with alternatives
- [x] **UI-02**: Swap interface shows 3-5 alternative meals matching same meal type and dietary restrictions
- [x] **UI-03**: User sees optional tooltip/expandable section explaining why meal was recommended
- [x] **UI-04**: Explainability shows simple reasoning (e.g., "You liked 5 Italian pasta dishes")
- [x] **UI-05**: User can access explainability by clicking info icon or "Why this meal?" link
- [x] **UI-06**: Plan view shows whether plan was generated by AI (cold start) or personalized (solver)

### Data Integrity

- [ ] **DATA-01**: Ratings persist across sessions and devices
- [x] **DATA-02**: Meal plan history is retained for at least 90 days
- [x] **DATA-03**: Rating changes update recommendations in next plan generation
...
- [x] **PERF-02**: Meal swap loads alternatives in <2 seconds
